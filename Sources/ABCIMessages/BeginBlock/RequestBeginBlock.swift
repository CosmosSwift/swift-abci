...
public struct RequestBeginBlock {
    ...
    public init(hash: Data, header: Header, lastCommitInfo: LastCommitInfo, byzantineValidators: [Evidence]) {
        self.hash = hash
        self.header = header
        self.lastCommitInfo = lastCommitInfo
        self.byzantineValidators = byzantineValidators
    }
}
