...
extension RESTClient {
    func broadcastTransactionCommit(id: Int, params: BroadcastTransactionCommitParameters) throws -> EventLoopFuture<RESTResponse<BroadcastTransactionCommitResponse>> {
