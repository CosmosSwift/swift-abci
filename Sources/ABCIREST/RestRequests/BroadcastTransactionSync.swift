...
extension RESTClient {
    public func broadcastTransactionSync(id: Int, params: BroadcastTransactionSyncParameters) throws -> EventLoopFuture<RESTResponse<BroadcastTransactionSyncResponse>> {
